...
from .base import silence_notifications, use_nodeinfo, with_remote_reference
...
class FollowRequestPolicyTestCase(TestCase):
    ...
    @override_settings(
        FEDERATION={
            "REJECT_FOLLOW_REQUEST_CHECKS": [
                "tests.core.test_policies.reject_all_policy",
            ]
        }
    )
    @httpretty.activate
    ...
    @override_settings(
        FEDERATION={
            "REJECT_FOLLOW_REQUEST_CHECKS": [
                "tests.core.test_policies.accept_policy",
            ]
        }
    )
    @httpretty.activate
    ...
    @override_settings(
        FEDERATION={
            "REJECT_FOLLOW_REQUEST_CHECKS": [
                "tests.core.test_policies.reject_bot_actors",
            ]
        }
    )
    @httpretty.activate
