    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(
                ...
                activitypub.core.models.integrity_proofs.KeySignatureBasedProofMixin,
            ),
        ),
        migrations.CreateModel(
            name="Domain",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "redirected_at",
                    model_utils.fields.MonitorField(
                        default=None, monitor="status", null=True, when={"redirected"}
                    ),
                ),
                (
                    "resolved_at",
                    model_utils.fields.MonitorField(
                        default=None, monitor="status", null=True, when={"resolved"}
                    ),
                ),
                (
                    "failed_at",
                    model_utils.fields.MonitorField(
                        default=None, monitor="status", null=True, when={"failed"}
                    ),
                ),
                (
                    "domain",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "authorize_client_key_endpoint",
                    models.URLField(blank=True, max_length=512, null=True),
                ),
                (
                    "sign_client_key_endpoint",
                    models.URLField(blank=True, max_length=512, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="in_collection_pages",
                        to="activitypub.reference",
                    ),
                ),
                (
