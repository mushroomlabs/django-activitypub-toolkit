...
class AppSettings:
    ...
    class LinkedData:
        default_contexts = {
            "activitypub.core.contexts.AS2_CONTEXT",
            "activitypub.core.contexts.SEC_V1_CONTEXT",
            "activitypub.core.contexts.W3C_IDENTITY_V1_CONTEXT",
            "activitypub.core.contexts.W3C_DID_V1_CONTEXT",
            "activitypub.core.contexts.W3C_DATAINTEGRITY_V1_CONTEXT",
            "activitypub.core.contexts.MULTIKEY_V1_CONTEXT",
            "activitypub.core.contexts.MASTODON_CONTEXT",
            "activitypub.core.contexts.MBIN_CONTEXT",
            "activitypub.core.contexts.LEMMY_CONTEXT",
            "activitypub.core.contexts.FUNKWHALE_CONTEXT",
            "activitypub.core.contexts.SCHEMA_LANGUAGE_CONTEXT",
        }
        extra_contexts = {}
        ...
        default_context_models = {
            ...
            "activitypub.core.models.ObjectContext",
            ...
            "activitypub.core.models.SecV1Context",
            "activitypub.core.models.SourceContentContext",
        }
        extra_context_models = {}
        disabled_context_models = {}
        projection_selector = "activitypub.core.projections.default_projection_selector"
    ...
    def load(self):
        ATTRS = {
            ...
            "OAUTH_ENABLED": (self.OAuth, "enabled"),
