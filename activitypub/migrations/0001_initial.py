# Generated by Django 5.2.7 on 2025-12-06 12:14

import activitypub.models.base
import activitypub.models.integrity_proofs
import activitypub.models.linked_data
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "any_of",
                    activitypub.models.linked_data.ReferenceField(
                        related_name="multiple_choice_alternatives", to="activitypub.reference"
                    ),
                ),
                (
                    "one_of",
                    activitypub.models.linked_data.ReferenceField(
                        related_name="alternatives", to="activitypub.reference"
                    ),
                ),
                (
                    "reference",
        ...
        migrations.AddField(
            ...
            name="attachments",
            field=activitypub.models.linked_data.ReferenceField(
                related_name="+", to="activitypub.reference"
            ),
        ),
        migrations.AddField(
            model_name="basecollectioncontext",
