# Generated by Django 5.1.5 on 2025-01-15 14:02
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(
                            choices=[
                                ...
                                (
                                    "current",
                                    "the most recent item(s) in a collection of resources",
                                ),
                                ("describedby", "information about the link's context."),
                                ("edit", "used to edit the link's context"),
                                (
                                    "edit-media",
                                    "can be used to edit media associated with the link",
                                ),
                                (
                                    "enclosure",
                                ...
                                (
                                    "predecessor-version",
                                    "predecessor version in the version history",
                                ),
                                (
                                    "previous",
                                    "Previous resource in an ordered series of resources",
                                ),
                                (
                                    "prev-archive",
