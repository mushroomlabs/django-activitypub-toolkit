# Generated by Django 5.2.7 on 2025-12-10 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "any_of",
                    activitypub.models.ReferenceField(related_name="multiple_choice_alternatives"),
                ),
                ("one_of", activitypub.models.ReferenceField(related_name="alternatives")),
                (
                    "reference",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name="attachments",
            field=activitypub.models.ReferenceField(related_name="+"),
        ),
        migrations.AddField(
            model_name="basecollectioncontext",
            name="attributed_to",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("creator", activitypub.models.ReferenceField(related_name="+")),
                ("owner", activitypub.models.ReferenceField(related_name="+")),
                (
                    "reference",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("also_known_as", activitypub.models.ReferenceField(related_name="+")),
                (
                    "endpoints",
                    models.ForeignKey(
                        blank=True,
                ...
                ("moved_to", activitypub.models.ReferenceField(related_name="+")),
                (
                    "outbox",
                    models.OneToOneField(
                        blank=True,
